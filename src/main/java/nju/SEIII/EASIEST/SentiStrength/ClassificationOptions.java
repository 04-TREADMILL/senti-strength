...
public class ClassificationOptions {
  ...
  public boolean printClassificationOptions(BufferedWriter wWriter, int iMinImprovement,
    ...
    try {
      ...
      wWriter.write(
          "\t" + iMultiOptimisations + "\t" + this.bgReduceNegativeEmotionInQuestionSentences +
              ...
              this.bgCorrectSpellingsWithRepeatedLetter + "\t" + this.bgUseEmoticons + "\t" +
              this.bgCapitalsBoostTermSentiment + "\t" + this.igMinRepeatedLettersForBoost + "\t" +
