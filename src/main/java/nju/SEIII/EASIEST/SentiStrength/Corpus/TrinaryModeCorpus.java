...
/**
 * @title: TrinaryModeCorpus
 * @Author: Stanton JoY
 * @Date: 2023/4/18 20:49
 */
public class TrinaryModeCorpus extends BaseCorpus {
    public TrinaryModeCorpus() {
        super();
    }

    public TrinaryModeCorpus(ClassificationOptions options, ClassificationResources resources) {
